...
const signatureCases: ReadonlyArray<{
  ...
  { name: "JPEG signature truncated after a fill byte", bytes: Uint8Array.of(0xff, 0xd8, 0xff, 0xff), type: "image/jpeg", expected: { ok: false, code: "signature" } },
  { name: "JPEG signature with a repeated fill byte", bytes: Uint8Array.of(0xff, 0xd8, 0xff, 0xff, 0xe0), type: "image/jpeg", expected: { ok: true } },
  { name: "JPEG signature with stuffed zero after fill bytes", bytes: Uint8Array.of(0xff, 0xd8, 0xff, 0xff, 0x00), type: "image/jpeg", expected: { ok: false, code: "signature" } },
