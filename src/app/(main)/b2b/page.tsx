...
export const metadata: Metadata = {
  title: "Мебель для бизнеса — офисная, торговая, гостиничная, учебная | ООО БТМ",
  description:
    "Производство мебели для бизнеса в Твери: офисная мебель, торговое оборудование, мебель для гостиниц и образовательных учреждений. ООО БТМ — собственное производство, индивидуальные проекты.",
  keywords:
    "офисная мебель Тверь, торговое оборудование Тверь, мебель для бизнеса, мебель для гостиниц, мебель для школ Тверь",
  alternates: {
    ...
    examples: [
      {
        ...
        description: "Парты с регулировкой высоты и наклона, тумбы учителя. Серия на 15 классов.",
        image: "/images/b2b-education-1.jpg",
        location: "Школа №12, г. Тверь",
      },
      {
        title: "Детский сад: игровая зона",
        description: "Игровые стеллажи, столы для творчества, шкафчики для раздевалки. Скруглённые углы, яркие фасады.",
        image: "/images/b2b-education-2.jpg",
        location: "Детский сад, г. Торжок",
      },
      {
        title: "Библиотека учебного центра",
        description: "Стеллажи для книг, читальные столы, стойка выдачи. МДФ с ламинацией.",
        image: "/images/b2b-education-3.jpg",
        location: "Учебный центр, г. Тверь",
      },
      {
        title: "Лаборатория колледжа",
        description: "Лабораторные столы с химически стойким покрытием, шкафы для реактивов.",
