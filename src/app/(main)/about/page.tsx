...
export const metadata: Metadata = {
  ...
  description:
    "ООО БТМ (TverKuhni) — собственное производство кухонь на заказ в Твери с 2014 года. Более 500 проектов, европейские материалы, гарантия 1 год.",
  keywords:
...
const advantages = [
  ...
  {
    title: "Эскиз проекта",
    description: "После заключения договора предоставляется эскиз проекта на утверждение.",
    icon: "🎨",
  },
  {
    title: "Готовность от 20 дней",
    description: "Срок изготовления — от 20 рабочих дней. Соблюдаем сроки по договору.",
    icon: "⏱️",
  },
];

const processSteps = [
  { step: 1, title: "Замер", description: "Замер — 1 500 ₽ (при оформлении заказа вычитается из стоимости)" },
  { step: 2, title: "Договор и аванс", description: "Заключаем договор, вносится аванс, предоставляется эскиз проекта на утверждение" },
  { step: 3, title: "Производство", description: "Изготавливаем кухню на собственном производстве в Твери от 20 рабочих дней" },
  { step: 4, title: "Доставка и сборка", description: "Доставляем и профессионально собираем кухню у вас дома" },
];
