...
export const metadata: Metadata = {
  title: "Наши работы — реализованные проекты кухонь в Твери | TverKuhni",
  description:
    "Портфолио кухонь на заказ от TverKuhni: более 500 реализованных проектов в Твери и Тверской области. Фото кухонь лофт, классика, минимализм. Отзывы клиентов.",
  keywords:
    "кухни фото Тверь, портфолио кухонь, реализованные проекты кухни, отзывы кухни Тверь",
  alternates: {
      ...
      <div className="container-custom">
        ...
        <div className="text-center py-12 bg-secondary/30 rounded-3xl mb-16">
          ...
          <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
            Оставьте заявку и получите бесплатный 3D-проект вашей кухни
          </p>
          <Link
            href="/#quiz"
