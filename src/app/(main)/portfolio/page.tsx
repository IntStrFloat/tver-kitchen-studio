...
export const metadata: Metadata = {
  ...
  description:
    "Портфолио кухонь на заказ от ООО БТМ (TverKuhni): более 500 реализованных проектов в Твери и Тверской области. Фото кухонь лофт, минимализм, скандинавский. Отзывы клиентов.",
  keywords:
