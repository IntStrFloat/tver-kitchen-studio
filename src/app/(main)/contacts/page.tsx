      ...
      <div className="container-custom">
              ...
              <address className="not-italic space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">Пн-Сб: 10:00 — 19:00</div>
            ...
            <div className="premium-card p-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-3 rounded-xl bg-[hsl(142,70%,45%)] text-white font-medium hover:opacity-90 transition-opacity"
                >
                  WhatsApp
                </a>
                <a
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-3 rounded-xl bg-[#4680C2] text-white font-medium hover:opacity-90 transition-opacity"
                >
                  ВКонтакте
                </a>
              </div>
        ...
        <div className="bg-secondary/30 rounded-3xl p-8 md:p-12 mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["Тверь", "Торжок", "Ржев", "Конаково", "Кимры", "Вышний Волочёк", "Бежецк", "Нелидово"].map((city) => (
              <span
                key={city}
