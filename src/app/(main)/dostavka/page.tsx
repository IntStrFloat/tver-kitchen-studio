...
export const metadata: Metadata = {
  title: "Доставка и установка кухонь по Твери и Тверской области | TverKuhni",
  description:
    "Доставка и установка кухонь на заказ по Твери — бесплатно. Доставка по Тверской области: Торжок, Ржев, Конаково, Кимры, Вышний Волочёк. Профессиональный монтаж.",
  keywords:
    "доставка кухонь Тверь, установка кухни Тверь, монтаж кухни, доставка мебели Тверская область",
  alternates: {
