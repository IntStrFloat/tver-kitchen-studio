...
export const metadata: Metadata = {
  title: "Блог о кухнях — статьи и советы от TverKuhni",
  description:
    "Полезные статьи о выборе кухни на заказ: материалы, стили, цены, планировки. Советы и руководства от производителя кухонь в Твери.",
  keywords:
    "блог кухни, статьи о кухнях, как выбрать кухню, советы по кухне, кухня на заказ статьи",
  alternates: {
