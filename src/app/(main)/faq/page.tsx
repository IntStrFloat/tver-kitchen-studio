...
export const metadata: Metadata = {
  title: "Вопросы и ответы о кухнях на заказ в Твери — FAQ | Kuhnitver",
  description:
    "Ответы на частые вопросы о заказе кухонь в Твери от производителя Kuhnitver. Сколько стоит кухня? Какие сроки изготовления? Какие материалы используете? Есть ли гарантия? Как проходит замер и установка? Подробные ответы на все вопросы о кухнях на заказ.",
  keywords:
  ...
  openGraph: {
    title: "Вопросы и ответы о кухнях на заказ в Твери — FAQ | Kuhnitver",
    description:
      "Ответы на частые вопросы о заказе кухонь в Твери от производителя Kuhnitver. Сколько стоит кухня? Сроки изготовления? Материалы? Гарантия? Замер и установка? Подробные ответы на все вопросы о кухнях на заказ.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Кухни на заказ в Твери — вопросы и ответы",
      },
    ],
  },
};
