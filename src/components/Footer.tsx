    ...
    <footer id="contacts" className="bg-foreground text-background">
      ...
      <div className="container-custom section-padding">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          >
            <h3 className="text-2xl font-bold mb-4">TverKuhni</h3>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+74951234567" className="text-background/70 hover:text-background transition-colors">
                  +7 (495) 123-45-67
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:info@tverkuhni.ru" className="text-background/70 hover:text-background transition-colors">
                  info@tverkuhni.ru
                </a>
              </li>
              <li className="flex items-center gap-3">
          ...
          >
            <h4 className="font-semibold mb-4">Работаем по всей области</h4>
      ...
      <div className="border-t border-background/10">
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-background/50">
            <p>© {currentYear} TverKuhni. Все права защищены.</p>
